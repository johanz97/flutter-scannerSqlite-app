...
export 'package:scanner_sqlite/models/scan_model.dart';
...
class DBProvider {
  ...
  Future<Database> initDB() async {
    //Path de almacenamiento de datos
  ...
  Future<List<ScanModel>?> getTodosScan(int id) async {
    final db = await database;
  ...
  Future<int> updateScan(ScanModel nuevo) async {
    final db = await database;
    final res = db.update('Scans', nuevo.toJson(),
